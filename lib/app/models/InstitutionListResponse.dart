...
class ApiInfo {
 ...
 factory ApiInfo.fromJson(Map<String, dynamic> json) {
   return ApiInfo(
     data: json['api_info'] != null ? (json['api_info'] as List).map((i) => DataInfo.fromJson(i)).toList() : null,
